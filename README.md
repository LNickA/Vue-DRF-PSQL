...
Коментарий от 09.11:
1. Контейнер шапки и блока карточек должны быть одной ширины - сделано. Привет в соответсвие с макетом,  но отел бы уточнить, что таблицы на страницах имеют ширину 1376px, по ним ровнял шапку, т.к. юзер будет на контентной части сайта находится больше. Мое мнение - привести шапку, блок карточек и таблицы к единому размеру.
2. В макете пункты карточек выстроены по высоте цветных картинок - сделано.
3. Некоректное поведение элементов при сжатии - сделано. Добавлен медиазапрос на страницу.
4. Нет поинтера при наведении на ссылки и кнопки - сделано.
5. Некоректный шрифт в кнопках, пунктах меню, подвале - сделано.
6. Нет функционала редактирования, удаления. Полное несоответствие блока макету - уточняется.
7. Странная реализация линии, адаптивность - сделано.
8. Не выровнен текст относительно  текста заголовков - сделано.
9. Некорректные отступы пунктов меню в шапке. - сделано.
10. Нет скругления у фонового блока - сделано.
11. Все ломается - тоже поправил.

Спасибо за обратную связь.
Не придал верстке большего значения в рамках тестового задания, на проду конечно будет Pixel Perfect.
